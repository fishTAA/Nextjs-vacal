...
function Vacalculator() {
	...
	const handleButtonClick = (percentage: SetStateAction<number>) => {
					...
					<div className="col-span-1">
					  <Select>
						...
						<SelectContent position="popper">
						  ...
						  <SelectItem value="arms">Right Arm</SelectItem>
						  <SelectItem value="arms">Left Arm</SelectItem>
						  <SelectItem value="legs">Right Leg</SelectItem>
						  <SelectItem value="legs">Left Leg</SelectItem>
						</SelectContent>
					  </Select>
					</div>
